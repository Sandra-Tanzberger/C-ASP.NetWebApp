...
{
  [Serializable]
	public class BO_Employments :Collection<BO_Employment>, IEnumerable<BO_Employment>, IComparer
	{
         ...
         public class Enumerator : IEnumerator
         {
	        ...
	        private BO_Employments t;

	        public Enumerator (BO_Employments t)
	        {
		        this.t = t;
	        }
		...
		public void Sort(string sortingExpression)
		{
			...
			BO_Employment[] elements =new BO_Employment[this.Items.Count];
			this.Items.CopyTo(elements,0);
			Array.Sort(elements,this);
			//clear old order and copy new order here
			this.Items.Clear();
			foreach(BO_Employment item in elements)
				this.Items.Add(item);
		}
		...
		{
			return new BO_Employments.Enumerator(this);
		}
