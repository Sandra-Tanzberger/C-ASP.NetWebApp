//
// Class	:	BO_InsuranceCoverages.cs
...
{
  [Serializable]
	public class BO_InsuranceCoverages :Collection<BO_InsuranceCoverage>, IEnumerable<BO_InsuranceCoverage>, IComparer
	{
         ...
         public class Enumerator : IEnumerator
         {
	        ...
	        private BO_InsuranceCoverages t;

	        public Enumerator (BO_InsuranceCoverages t)
	        {
		        this.t = t;
	        }
		...
		public void Sort(string sortingExpression)
		{
			...
			BO_InsuranceCoverage[] elements =new BO_InsuranceCoverage[this.Items.Count];
			this.Items.CopyTo(elements,0);
			Array.Sort(elements,this);
			//clear old order and copy new order here
			this.Items.Clear();
			foreach(BO_InsuranceCoverage item in elements)
				this.Items.Add(item);
		}
		...
		{
			return new BO_InsuranceCoverages.Enumerator(this);
		}
