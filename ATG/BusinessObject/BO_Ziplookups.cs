...
{
    [Serializable]
    public class BO_Ziplookups : Collection<BO_Ziplookup>, IEnumerable<BO_Ziplookup>, IComparer
	{
         ...
         public class Enumerator : IEnumerator
         {
	        ...
	        private BO_Ziplookups t;

	        public Enumerator (BO_Ziplookups t)
	        {
		        this.t = t;
	        }
		...
		public void Sort(string sortingExpression)
		{
			...
			BO_Ziplookup[] elements =new BO_Ziplookup[this.Items.Count];
			this.Items.CopyTo(elements,0);
			Array.Sort(elements,this);
			//clear old order and copy new order here
			this.Items.Clear();
			foreach(BO_Ziplookup item in elements)
				this.Items.Add(item);
		}
		...
		{
			return new BO_Ziplookups.Enumerator(this);
		}
