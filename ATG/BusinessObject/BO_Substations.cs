...
{
    [Serializable]
    public class BO_Substations : Collection<BO_Substation>, IEnumerable<BO_Substation>, IComparer
	{
         ...
         public class Enumerator : IEnumerator
         {
	        ...
	        private BO_Substations t;

	        public Enumerator (BO_Substations t)
	        {
		        this.t = t;
	        }
		...
		public void Sort(string sortingExpression)
		{
			...
			BO_Substation[] elements =new BO_Substation[this.Items.Count];
			this.Items.CopyTo(elements,0);
			Array.Sort(elements,this);
			//clear old order and copy new order here
			this.Items.Clear();
			foreach(BO_Substation item in elements)
				this.Items.Add(item);
		}
		...
		{
			return new BO_Substations.Enumerator(this);
		}
