...
{
    [Serializable]
    public class BO_Messages : Collection<BO_Message>, IEnumerable<BO_Message>, IComparer
	{
         ...
         public class Enumerator : IEnumerator
         {
	        ...
	        private BO_Messages t;

	        public Enumerator (BO_Messages t)
	        {
		        this.t = t;
	        }
		...
		{
			return new BO_Messages.Enumerator(this);
		}
