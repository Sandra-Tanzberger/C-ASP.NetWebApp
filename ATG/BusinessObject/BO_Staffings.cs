...
{
    [Serializable]
    public class BO_Staffings : Collection<BO_Staffing>, IEnumerable<BO_Staffing>, IComparer
	{
         ...
         public class Enumerator : IEnumerator
         {
	        ...
	        private BO_Staffings t;

	        public Enumerator (BO_Staffings t)
	        {
		        this.t = t;
	        }
		...
		{
			return new BO_Staffings.Enumerator(this);
		}
