//
// Class	:	BO_Parishes.cs
// Author	:  	Ignyte Software © 2006 (DLG 1.5.64)
// Date		:	09/21/2010 12:38:18 PM
//
...
{
    [Serializable]
    public class BO_Parishes : Collection<BO_Parishe>, IEnumerable<BO_Parishe>, IComparer
	{
         ...
         public class Enumerator : IEnumerator
         {
	        ...
	        private BO_Parishes t;

	        public Enumerator (BO_Parishes t)
	        {
		        this.t = t;
	        }
		...
		{
			return new BO_Parishes.Enumerator(this);
		}
