//
// Class	:	BO_ApplicationItems.cs
// Author	:  	Ignyte Software © 2006 (DLG 1.5.64)
// Date		:	12/08/2010 8:37:31 PM
//
...
{
  [Serializable]
	public class BO_ApplicationItems :Collection<BO_ApplicationItem>, IEnumerable<BO_ApplicationItem>, IComparer
	{
         ...
         public class Enumerator : IEnumerator
         {
	        ...
	        private BO_ApplicationItems t;

	        public Enumerator (BO_ApplicationItems t)
	        {
		        this.t = t;
	        }
		...
		public void Sort(string sortingExpression)
		{
			...
			BO_ApplicationItem[] elements =new BO_ApplicationItem[this.Items.Count];
			this.Items.CopyTo(elements,0);
			Array.Sort(elements,this);
			//clear old order and copy new order here
			this.Items.Clear();
			foreach(BO_ApplicationItem item in elements)
				this.Items.Add(item);
		}
		...
		{
			return new BO_ApplicationItems.Enumerator(this);
		}
