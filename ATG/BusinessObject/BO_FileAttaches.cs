...
{
    [Serializable]
    public class BO_FileAttaches : Collection<BO_FileAttach>, IEnumerable<BO_FileAttach>, IComparer
	{
         ...
         public class Enumerator : IEnumerator
         {
	        ...
	        private BO_FileAttaches t;

	        public Enumerator (BO_FileAttaches t)
	        {
		        this.t = t;
	        }
		...
		public void Sort(string sortingExpression)
		{
			...
			BO_FileAttach[] elements =new BO_FileAttach[this.Items.Count];
			this.Items.CopyTo(elements,0);
			Array.Sort(elements,this);
			//clear old order and copy new order here
			this.Items.Clear();
			foreach(BO_FileAttach item in elements)
				this.Items.Add(item);
		}
		...
		{
			return new BO_FileAttaches.Enumerator(this);
		}
