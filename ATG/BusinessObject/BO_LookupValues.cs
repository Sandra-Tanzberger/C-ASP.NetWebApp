...
{
	public class BO_LookupValues :Collection<BO_LookupValue>, IEnumerable<BO_LookupValue>, IComparer
	{
         ...
         public class Enumerator : IEnumerator
         {
	        ...
	        private BO_LookupValues t;

	        public Enumerator (BO_LookupValues t)
	        {
		        this.t = t;
	        }
		...
		public void Sort(string sortingExpression)
		{
			...
			BO_LookupValue[] elements =new BO_LookupValue[this.Items.Count];
			this.Items.CopyTo(elements,0);
			Array.Sort(elements,this);
			//clear old order and copy new order here
			this.Items.Clear();
			foreach(BO_LookupValue item in elements)
				this.Items.Add(item);
		}
		...
		{
			return new BO_LookupValues.Enumerator(this);
		}
