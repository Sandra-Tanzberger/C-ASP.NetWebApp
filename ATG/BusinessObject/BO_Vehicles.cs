...
{
    [Serializable]
    public class BO_Vehicles : Collection<BO_Vehicle>, IEnumerable<BO_Vehicle>, IComparer
	{
         ...
         public class Enumerator : IEnumerator
         {
	        ...
	        private BO_Vehicles t;

	        public Enumerator (BO_Vehicles t)
	        {
		        this.t = t;
	        }
		...
		{
			return new BO_Vehicles.Enumerator(this);
		}
