...
{
    [Serializable]
    public class BO_ProviderLogins : Collection<BO_ProviderLogin>, IEnumerable<BO_ProviderLogin>, IComparer
	{
         ...
         public class Enumerator : IEnumerator
         {
	        ...
	        private BO_ProviderLogins t;

	        public Enumerator (BO_ProviderLogins t)
	        {
		        this.t = t;
	        }
		...
		public void Sort(string sortingExpression)
		{
			...
			BO_ProviderLogin[] elements =new BO_ProviderLogin[this.Items.Count];
			this.Items.CopyTo(elements,0);
			Array.Sort(elements,this);
			//clear old order and copy new order here
			this.Items.Clear();
			foreach(BO_ProviderLogin item in elements)
				this.Items.Add(item);
		}
		...
		{
			return new BO_ProviderLogins.Enumerator(this);
		}
