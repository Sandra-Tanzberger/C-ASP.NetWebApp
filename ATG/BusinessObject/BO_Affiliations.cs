...
{
    [Serializable]
    public class BO_Affiliations : Collection<BO_Affiliation>, IEnumerable<BO_Affiliation>, IComparer
	{
         ...
         public class Enumerator : IEnumerator
         {
	        ...
	        private BO_Affiliations t;

	        public Enumerator (BO_Affiliations t)
	        {
		        this.t = t;
	        }
		...
		public void Sort(string sortingExpression)
		{
			...
			BO_Affiliation[] elements =new BO_Affiliation[this.Items.Count];
			this.Items.CopyTo(elements,0);
			Array.Sort(elements,this);
			//clear old order and copy new order here
			this.Items.Clear();
			foreach(BO_Affiliation item in elements)
				this.Items.Add(item);
		}
		...
		{
			return new BO_Affiliations.Enumerator(this);
		}
