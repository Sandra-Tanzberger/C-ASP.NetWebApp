//
// Class	:	BO_ApplicationItemActions.cs
// Author	:  	Ignyte Software © 2006 (DLG 1.5.64)
// Date		:	09/21/2010 2:43:17 PM
//
...
{
    [Serializable]
    public class BO_ApplicationItemActions : Collection<BO_ApplicationItemAction>, IEnumerable<BO_ApplicationItemAction>, IComparer
	{
         ...
         public class Enumerator : IEnumerator
         {
	        ...
	        private BO_ApplicationItemActions t;

	        public Enumerator (BO_ApplicationItemActions t)
	        {
		        this.t = t;
	        }
		...
		public void Sort(string sortingExpression)
		{
			...
			BO_ApplicationItemAction[] elements =new BO_ApplicationItemAction[this.Items.Count];
			this.Items.CopyTo(elements,0);
			Array.Sort(elements,this);
			//clear old order and copy new order here
			this.Items.Clear();
			foreach(BO_ApplicationItemAction item in elements)
				this.Items.Add(item);
		}
		...
		{
			return new BO_ApplicationItemActions.Enumerator(this);
		}
