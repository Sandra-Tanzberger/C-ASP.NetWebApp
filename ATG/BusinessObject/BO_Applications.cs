...
{
    [Serializable]
    public class BO_Applications : Collection<BO_Application>, IEnumerable<BO_Application>, IComparer
	{
         ...
         public class Enumerator : IEnumerator
         {
	        ...
	        private BO_Applications t;

	        public Enumerator (BO_Applications t)
	        {
		        this.t = t;
	        }
		...
		public void Sort(string sortingExpression)
		{
			...
			BO_Application[] elements =new BO_Application[this.Items.Count];
			this.Items.CopyTo(elements,0);
			Array.Sort(elements,this);
			//clear old order and copy new order here
			this.Items.Clear();
			foreach(BO_Application item in elements)
				this.Items.Add(item);
		}
		...
		{
			return new BO_Applications.Enumerator(this);
		}
