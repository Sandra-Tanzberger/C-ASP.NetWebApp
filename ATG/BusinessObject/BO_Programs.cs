...
{
    [Serializable]
    public class BO_Programs : Collection<BO_Program>, IEnumerable<BO_Program>, IComparer
	{
         ...
         public class Enumerator : IEnumerator
         {
	        ...
	        private BO_Programs t;

	        public Enumerator (BO_Programs t)
	        {
		        this.t = t;
	        }
		...
		{
			return new BO_Programs.Enumerator(this);
		}
