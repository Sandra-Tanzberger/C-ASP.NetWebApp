...
{
    [Serializable]
    public class BO_OwnerPeople : Collection<BO_OwnerPerson>, IEnumerable<BO_OwnerPerson>, IComparer
	{
         ...
         public class Enumerator : IEnumerator
         {
	        ...
	        private BO_OwnerPeople t;

	        public Enumerator (BO_OwnerPeople t)
	        {
		        this.t = t;
	        }
		...
		public void Sort(string sortingExpression)
		{
			...
			BO_OwnerPerson[] elements =new BO_OwnerPerson[this.Items.Count];
			this.Items.CopyTo(elements,0);
			Array.Sort(elements,this);
			//clear old order and copy new order here
			this.Items.Clear();
			foreach(BO_OwnerPerson item in elements)
				this.Items.Add(item);
		}
		...
		{
			return new BO_OwnerPeople.Enumerator(this);
		}
