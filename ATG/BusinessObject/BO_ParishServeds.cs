//
// Class	:	BO_ParishServeds.cs
// Author	:  	Ignyte Software © 2006 (DLG 1.5.64)
// Date		:	12/01/2010 10:45:45 AM
//
...
{
    [Serializable]
	public class BO_ParishServeds :Collection<BO_ParishServed>, IEnumerable<BO_ParishServed>, IComparer
	{
         ...
         public class Enumerator : IEnumerator
         {
	        ...
	        private BO_ParishServeds t;

	        public Enumerator (BO_ParishServeds t)
	        {
		        this.t = t;
	        }
		...
		public void Sort(string sortingExpression)
		{
			...
			BO_ParishServed[] elements =new BO_ParishServed[this.Items.Count];
			this.Items.CopyTo(elements,0);
			Array.Sort(elements,this);
			//clear old order and copy new order here
			this.Items.Clear();
			foreach(BO_ParishServed item in elements)
				this.Items.Add(item);
		}
		...
		{
			return new BO_ParishServeds.Enumerator(this);
		}
