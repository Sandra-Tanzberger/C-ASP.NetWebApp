...
{
	public class BO_BsnsrlLvls :Collection<BO_BsnsrlLvl>, IEnumerable<BO_BsnsrlLvl>, IComparer
	{
         ...
         public class Enumerator : IEnumerator
         {
	        ...
	        private BO_BsnsrlLvls t;

	        public Enumerator (BO_BsnsrlLvls t)
	        {
		        this.t = t;
	        }
		...
		public void Sort(string sortingExpression)
		{
			...
			BO_BsnsrlLvl[] elements =new BO_BsnsrlLvl[this.Items.Count];
			this.Items.CopyTo(elements,0);
			Array.Sort(elements,this);
			//clear old order and copy new order here
			this.Items.Clear();
			foreach(BO_BsnsrlLvl item in elements)
				this.Items.Add(item);
		}
		...
		{
			return new BO_BsnsrlLvls.Enumerator(this);
		}
