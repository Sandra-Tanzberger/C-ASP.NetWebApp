//
// Class	:	BO_BsnsrlRslts.cs
// Author	:  	Ignyte Software © 2006 (DLG 1.5.64)
// Date		:	10/06/2010 4:46:12 PM
//
...
{
	public class BO_BsnsrlRslts :Collection<BO_BsnsrlRslt>, IEnumerable<BO_BsnsrlRslt>, IComparer
	{
         ...
         public class Enumerator : IEnumerator
         {
	        ...
	        private BO_BsnsrlRslts t;

	        public Enumerator (BO_BsnsrlRslts t)
	        {
		        this.t = t;
	        }
		...
		public void Sort(string sortingExpression)
		{
			...
			BO_BsnsrlRslt[] elements =new BO_BsnsrlRslt[this.Items.Count];
			this.Items.CopyTo(elements,0);
			Array.Sort(elements,this);
			//clear old order and copy new order here
			this.Items.Clear();
			foreach(BO_BsnsrlRslt item in elements)
				this.Items.Add(item);
		}
		...
		{
			return new BO_BsnsrlRslts.Enumerator(this);
		}
