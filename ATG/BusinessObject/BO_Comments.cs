//
// Class	:	BO_Comments.cs
// Author	:  	Ignyte Software © 2006 (DLG 1.5.64)
// Date		:	09/21/2010 12:13:20 PM
//
...
{
    [Serializable]
    public class BO_Comments : Collection<BO_Comment>, IEnumerable<BO_Comment>, IComparer
	{
         ...
         public class Enumerator : IEnumerator
         {
	        ...
	        private BO_Comments t;

	        public Enumerator (BO_Comments t)
	        {
		        this.t = t;
	        }
		...
		{
			return new BO_Comments.Enumerator(this);
		}
