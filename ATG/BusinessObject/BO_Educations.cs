...
{
  [Serializable]
	public class BO_Educations :Collection<BO_Education>, IEnumerable<BO_Education>, IComparer
	{
         ...
         public class Enumerator : IEnumerator
         {
	        ...
	        private BO_Educations t;

	        public Enumerator (BO_Educations t)
	        {
		        this.t = t;
	        }
		...
		public void Sort(string sortingExpression)
		{
			...
			BO_Education[] elements =new BO_Education[this.Items.Count];
			this.Items.CopyTo(elements,0);
			Array.Sort(elements,this);
			//clear old order and copy new order here
			this.Items.Clear();
			foreach(BO_Education item in elements)
				this.Items.Add(item);
		}
		...
		{
			return new BO_Educations.Enumerator(this);
		}
