//
// Class	:	BO_ErrorLogs.cs
// Author	:  	Ignyte Software © 2006 (DLG 1.5.64)
// Date		:	12/01/2010 10:45:46 AM
//
...
{
    [Serializable]
    public class BO_ErrorLogs : Collection<BO_ErrorLog>, IEnumerable<BO_ErrorLog>, IComparer
	{
         ...
         public class Enumerator : IEnumerator
         {
	        ...
	        private BO_ErrorLogs t;

	        public Enumerator (BO_ErrorLogs t)
	        {
		        this.t = t;
	        }
		...
		{
			return new BO_ErrorLogs.Enumerator(this);
		}
