//
// Class	:	BO_ChecklistItemValidActions.cs
// Author	:  	Ignyte Software © 2006 (DLG 1.5.64)
// Date		:	09/21/2010 2:43:15 PM
//
...
{
    [Serializable]
    public class BO_ChecklistItemValidActions : Collection<BO_ChecklistItemValidAction>, IEnumerable<BO_ChecklistItemValidAction>, IComparer
	{
         ...
         public class Enumerator : IEnumerator
         {
	        ...
	        private BO_ChecklistItemValidActions t;

	        public Enumerator (BO_ChecklistItemValidActions t)
	        {
		        this.t = t;
	        }
		...
		public void Sort(string sortingExpression)
		{
			...
			BO_ChecklistItemValidAction[] elements =new BO_ChecklistItemValidAction[this.Items.Count];
			this.Items.CopyTo(elements,0);
			Array.Sort(elements,this);
			//clear old order and copy new order here
			this.Items.Clear();
			foreach(BO_ChecklistItemValidAction item in elements)
				this.Items.Add(item);
		}
		...
		{
			return new BO_ChecklistItemValidActions.Enumerator(this);
		}
