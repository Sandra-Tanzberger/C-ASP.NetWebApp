...
{
	public class BO_RlOprtrs :Collection<BO_RlOprtr>, IEnumerable<BO_RlOprtr>, IComparer
	{
         ...
         public class Enumerator : IEnumerator
         {
	        ...
	        private BO_RlOprtrs t;

	        public Enumerator (BO_RlOprtrs t)
	        {
		        this.t = t;
	        }
		...
		{
			return new BO_RlOprtrs.Enumerator(this);
		}
