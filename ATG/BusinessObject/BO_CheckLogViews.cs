...
{
  [Serializable]
	public class BO_CheckLogViews :Collection<BO_CheckLogView>, IEnumerable<BO_CheckLogView>, IComparer
	{
         ...
         public class Enumerator : IEnumerator
         {
	        ...
	        private BO_CheckLogViews t;

	        public Enumerator (BO_CheckLogViews t)
	        {
		        this.t = t;
	        }
		...
		public void Sort(string sortingExpression)
		{
			...
			BO_CheckLogView[] elements =new BO_CheckLogView[this.Items.Count];
			this.Items.CopyTo(elements,0);
			Array.Sort(elements,this);
			//clear old order and copy new order here
			this.Items.Clear();
			foreach(BO_CheckLogView item in elements)
				this.Items.Add(item);
		}
		...
		{
			return new BO_CheckLogViews.Enumerator(this);
		}
