//
// Class	:	BO_CapacityPrimaryKey.cs
...
{
    public class BO_CapacityPrimaryKey
    {
        ...
        /// </summary>
		public BO_CapacityPrimaryKey(decimal? capacityID,decimal? popsIntID,decimal? applicationID) 
		{
	
			
            this._capacityIDNonDefault = capacityID;
		...
		/// <summary>
		/// This property is mapped to the "CAPACITY_ID" field.  Mandatory.
		/// </summary>
		...
		public NameValueCollection GetKeysAndValues() 
		{
			...
			nvc.Add("CapacityID",_capacityIDNonDefault.ToString());
