//
// Class	:	BO_AuditLogs.cs
// Author	:  	Ignyte Software © 2006 (DLG 1.5.64)
// Date		:	10/06/2010 4:46:06 PM
//
...
{
    [Serializable]
    public class BO_AuditLogs : Collection<BO_AuditLog>, IEnumerable<BO_AuditLog>, IComparer
	{
         ...
         public class Enumerator : IEnumerator
         {
	        ...
	        private BO_AuditLogs t;

	        public Enumerator (BO_AuditLogs t)
	        {
		        this.t = t;
	        }
		...
		{
			return new BO_AuditLogs.Enumerator(this);
		}
