...
{
	public class BO_Letters :Collection<BO_Letter>, IEnumerable<BO_Letter>, IComparer
	{
         ...
         public class Enumerator : IEnumerator
         {
	        ...
	        private BO_Letters t;

	        public Enumerator (BO_Letters t)
	        {
		        this.t = t;
	        }
		...
		{
			return new BO_Letters.Enumerator(this);
		}
