//
// Class	:	BO_ErrorMessageLookups.cs
...
{
    [Serializable]
    public class BO_ErrorMessageLookups : Collection<BO_ErrorMessageLookup>, IEnumerable<BO_ErrorMessageLookup>, IComparer
	{
         ...
         public class Enumerator : IEnumerator
         {
	        ...
	        private BO_ErrorMessageLookups t;

	        public Enumerator (BO_ErrorMessageLookups t)
	        {
		        this.t = t;
	        }
		...
		public void Sort(string sortingExpression)
		{
			...
			BO_ErrorMessageLookup[] elements =new BO_ErrorMessageLookup[this.Items.Count];
			this.Items.CopyTo(elements,0);
			Array.Sort(elements,this);
			//clear old order and copy new order here
			this.Items.Clear();
			foreach(BO_ErrorMessageLookup item in elements)
				this.Items.Add(item);
		}
		...
		{
			return new BO_ErrorMessageLookups.Enumerator(this);
		}
