//
// Class	:	BO_BusinessProcesses.cs
// Author	:  	Ignyte Software © 2006 (DLG 1.5.64)
// Date		:	04/08/2010 12:25:04 PM
//
...
{
    [Serializable]
    public class BO_BusinessProcesses : Collection<BO_BusinessProcesse>, IEnumerable<BO_BusinessProcesse>, IComparer
	{
         ...
         public class Enumerator : IEnumerator
         {
	        ...
	        private BO_BusinessProcesses t;

	        public Enumerator (BO_BusinessProcesses t)
	        {
		        this.t = t;
	        }
		...
		public void Sort(string sortingExpression)
		{
			...
			BO_BusinessProcesse[] elements =new BO_BusinessProcesse[this.Items.Count];
			this.Items.CopyTo(elements,0);
			Array.Sort(elements,this);
			//clear old order and copy new order here
			this.Items.Clear();
			foreach(BO_BusinessProcesse item in elements)
				this.Items.Add(item);
		}
		...
		{
			return new BO_BusinessProcesses.Enumerator(this);
		}
