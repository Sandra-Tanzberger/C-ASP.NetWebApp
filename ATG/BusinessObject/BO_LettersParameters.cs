...
{
	public class BO_LettersParameters :Collection<BO_LettersParameter>, IEnumerable<BO_LettersParameter>, IComparer
	{
         ...
         public class Enumerator : IEnumerator
         {
	        ...
	        private BO_LettersParameters t;

	        public Enumerator (BO_LettersParameters t)
	        {
		        this.t = t;
	        }
		...
		public void Sort(string sortingExpression)
		{
			...
			BO_LettersParameter[] elements =new BO_LettersParameter[this.Items.Count];
			this.Items.CopyTo(elements,0);
			Array.Sort(elements,this);
			//clear old order and copy new order here
			this.Items.Clear();
			foreach(BO_LettersParameter item in elements)
				this.Items.Add(item);
		}
		...
		{
			return new BO_LettersParameters.Enumerator(this);
		}
