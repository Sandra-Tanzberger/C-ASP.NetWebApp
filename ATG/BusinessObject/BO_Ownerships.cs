...
{
    [Serializable]
    public class BO_Ownerships : Collection<BO_Ownership>, IEnumerable<BO_Ownership>, IComparer
	{
         ...
         public class Enumerator : IEnumerator
         {
	        ...
	        private BO_Ownerships t;

	        public Enumerator (BO_Ownerships t)
	        {
		        this.t = t;
	        }
		...
		public void Sort(string sortingExpression)
		{
			...
			BO_Ownership[] elements =new BO_Ownership[this.Items.Count];
			this.Items.CopyTo(elements,0);
			Array.Sort(elements,this);
			//clear old order and copy new order here
			this.Items.Clear();
			foreach(BO_Ownership item in elements)
				this.Items.Add(item);
		}
		...
		{
			return new BO_Ownerships.Enumerator(this);
		}
