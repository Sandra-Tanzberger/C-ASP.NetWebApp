//
// Class	:	BO_ProgramBusinessProcesses.cs
// Author	:  	Ignyte Software © 2006 (DLG 1.5.64)
// Date		:	10/06/2010 4:46:13 PM
//
...
{
	public class BO_ProgramBusinessProcesses :Collection<BO_ProgramBusinessProcesse>, IEnumerable<BO_ProgramBusinessProcesse>, IComparer
	{
         ...
         public class Enumerator : IEnumerator
         {
	        ...
	        private BO_ProgramBusinessProcesses t;

	        public Enumerator (BO_ProgramBusinessProcesses t)
	        {
		        this.t = t;
	        }
		...
		public void Sort(string sortingExpression)
		{
			...
			BO_ProgramBusinessProcesse[] elements =new BO_ProgramBusinessProcesse[this.Items.Count];
			this.Items.CopyTo(elements,0);
			Array.Sort(elements,this);
			//clear old order and copy new order here
			this.Items.Clear();
			foreach(BO_ProgramBusinessProcesse item in elements)
				this.Items.Add(item);
		}
		...
		{
			return new BO_ProgramBusinessProcesses.Enumerator(this);
		}
