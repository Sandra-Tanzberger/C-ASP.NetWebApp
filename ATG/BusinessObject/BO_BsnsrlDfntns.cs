//
// Class	:	BO_BsnsrlDfntns.cs
// Author	:  	Ignyte Software © 2006 (DLG 1.5.64)
// Date		:	10/06/2010 4:46:04 PM
//
...
{
	public class BO_BsnsrlDfntns :Collection<BO_BsnsrlDfntn>, IEnumerable<BO_BsnsrlDfntn>, IComparer
	{
         ...
         public class Enumerator : IEnumerator
         {
	        ...
	        private BO_BsnsrlDfntns t;

	        public Enumerator (BO_BsnsrlDfntns t)
	        {
		        this.t = t;
	        }
		...
		public void Sort(string sortingExpression)
		{
			...
			BO_BsnsrlDfntn[] elements =new BO_BsnsrlDfntn[this.Items.Count];
			this.Items.CopyTo(elements,0);
			Array.Sort(elements,this);
			//clear old order and copy new order here
			this.Items.Clear();
			foreach(BO_BsnsrlDfntn item in elements)
				this.Items.Add(item);
		}
		...
		{
			return new BO_BsnsrlDfntns.Enumerator(this);
		}
