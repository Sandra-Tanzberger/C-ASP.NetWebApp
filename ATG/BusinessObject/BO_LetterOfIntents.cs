//
// Class	:	BO_LetterOfIntents.cs
// Author	:  	Ignyte Software © 2006 (DLG 1.5.64)
// Date		:	12/27/2010 12:03:11 PM
//
...
{
  [Serializable]
	public class BO_LetterOfIntents :Collection<BO_LetterOfIntent>, IEnumerable<BO_LetterOfIntent>, IComparer
	{
         ...
         public class Enumerator : IEnumerator
         {
	        ...
	        private BO_LetterOfIntents t;

	        public Enumerator (BO_LetterOfIntents t)
	        {
		        this.t = t;
	        }
		...
		public void Sort(string sortingExpression)
		{
			...
			BO_LetterOfIntent[] elements =new BO_LetterOfIntent[this.Items.Count];
			this.Items.CopyTo(elements,0);
			Array.Sort(elements,this);
			//clear old order and copy new order here
			this.Items.Clear();
			foreach(BO_LetterOfIntent item in elements)
				this.Items.Add(item);
		}
		...
		{
			return new BO_LetterOfIntents.Enumerator(this);
		}
