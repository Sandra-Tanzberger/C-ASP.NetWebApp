//
// Class	:	BO_FeeModels.cs
// Author	:  	Ignyte Software © 2006 (DLG 1.5.64)
// Date		:	09/21/2010 2:43:26 PM
//
...
{
    [Serializable]
    public class BO_FeeModels : Collection<BO_FeeModel>, IEnumerable<BO_FeeModel>, IComparer
	{
         ...
         public class Enumerator : IEnumerator
         {
	        ...
	        private BO_FeeModels t;

	        public Enumerator (BO_FeeModels t)
	        {
		        this.t = t;
	        }
		...
		{
			return new BO_FeeModels.Enumerator(this);
		}
