//
// Class	:	BO_ImplTyps.cs
// Author	:  	Ignyte Software © 2006 (DLG 1.5.64)
// Date		:	10/06/2010 4:46:01 PM
//
...
{
	public class BO_ImplTyps :Collection<BO_ImplTyp>, IEnumerable<BO_ImplTyp>, IComparer
	{
         ...
         public class Enumerator : IEnumerator
         {
	        ...
	        private BO_ImplTyps t;

	        public Enumerator (BO_ImplTyps t)
	        {
		        this.t = t;
	        }
		...
		{
			return new BO_ImplTyps.Enumerator(this);
		}
