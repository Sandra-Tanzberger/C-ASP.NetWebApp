...
{
    [Serializable]
    public class BO_Regions : Collection<BO_Region>, IEnumerable<BO_Region>, IComparer
	{
         ...
         public class Enumerator : IEnumerator
         {
	        ...
	        private BO_Regions t;

	        public Enumerator (BO_Regions t)
	        {
		        this.t = t;
	        }
		...
		{
			return new BO_Regions.Enumerator(this);
		}
