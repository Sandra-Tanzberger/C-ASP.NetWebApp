...
{
	public class BO_LettersQueues :Collection<BO_LettersQueue>, IEnumerable<BO_LettersQueue>, IComparer
	{
         ...
         public class Enumerator : IEnumerator
         {
	        ...
	        private BO_LettersQueues t;

	        public Enumerator (BO_LettersQueues t)
	        {
		        this.t = t;
	        }
		...
		public void Sort(string sortingExpression)
		{
			...
			BO_LettersQueue[] elements =new BO_LettersQueue[this.Items.Count];
			this.Items.CopyTo(elements,0);
			Array.Sort(elements,this);
			//clear old order and copy new order here
			this.Items.Clear();
			foreach(BO_LettersQueue item in elements)
				this.Items.Add(item);
		}
		...
		{
			return new BO_LettersQueues.Enumerator(this);
		}
