...
{
    [Serializable]
    public class BO_SpecialtyUnits : Collection<BO_SpecialtyUnit>, IEnumerable<BO_SpecialtyUnit>, IComparer
	{
         ...
         public class Enumerator : IEnumerator
         {
	        ...
	        private BO_SpecialtyUnits t;

	        public Enumerator (BO_SpecialtyUnits t)
	        {
		        this.t = t;
	        }
		...
		public void Sort(string sortingExpression)
		{
			...
			BO_SpecialtyUnit[] elements =new BO_SpecialtyUnit[this.Items.Count];
			this.Items.CopyTo(elements,0);
			Array.Sort(elements,this);
			//clear old order and copy new order here
			this.Items.Clear();
			foreach(BO_SpecialtyUnit item in elements)
				this.Items.Add(item);
		}
		...
		{
			return new BO_SpecialtyUnits.Enumerator(this);
		}
