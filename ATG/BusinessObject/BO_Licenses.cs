...
{
  [Serializable]
	public class BO_Licenses :Collection<BO_License>, IEnumerable<BO_License>, IComparer
	{
         ...
         public class Enumerator : IEnumerator
         {
	        ...
	        private BO_Licenses t;

	        public Enumerator (BO_Licenses t)
	        {
		        this.t = t;
	        }
		...
		{
			return new BO_Licenses.Enumerator(this);
		}
