...
{
	public class BO_OprtrTyps :Collection<BO_OprtrTyp>, IEnumerable<BO_OprtrTyp>, IComparer
	{
         ...
         public class Enumerator : IEnumerator
         {
	        ...
	        private BO_OprtrTyps t;

	        public Enumerator (BO_OprtrTyps t)
	        {
		        this.t = t;
	        }
		...
		{
			return new BO_OprtrTyps.Enumerator(this);
		}
