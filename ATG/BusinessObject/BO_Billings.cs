//
// Class	:	BO_Billings.cs
// Author	:  	Ignyte Software © 2006 (DLG 1.5.64)
// Date		:	05/10/2011 7:58:20 AM
//
...
{
  [Serializable]
	public class BO_Billings :Collection<BO_Billing>, IEnumerable<BO_Billing>, IComparer
	{
         ...
         public class Enumerator : IEnumerator
         {
	        ...
	        private BO_Billings t;

	        public Enumerator (BO_Billings t)
	        {
		        this.t = t;
	        }
		...
		{
			return new BO_Billings.Enumerator(this);
		}
