//
// Class	:	BO_AppSetups.cs
// Author	:  	Ignyte Software © 2006 (DLG 1.5.64)
// Date		:	11/15/2010 10:03:56 AM
//
...
{
    [Serializable]
    public class BO_AppSetups : Collection<BO_AppSetup>, IEnumerable<BO_AppSetup>, IComparer
	{
         ...
         public class Enumerator : IEnumerator
         {
	        ...
	        private BO_AppSetups t;

	        public Enumerator (BO_AppSetups t)
	        {
		        this.t = t;
	        }
		...
		{
			return new BO_AppSetups.Enumerator(this);
		}
