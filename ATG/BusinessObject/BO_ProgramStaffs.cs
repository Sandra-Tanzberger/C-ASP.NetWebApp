...
{
	public class BO_ProgramStaffs :Collection<BO_ProgramStaff>, IEnumerable<BO_ProgramStaff>, IComparer
	{
         ...
         public class Enumerator : IEnumerator
         {
	        ...
	        private BO_ProgramStaffs t;

	        public Enumerator (BO_ProgramStaffs t)
	        {
		        this.t = t;
	        }
		...
		public void Sort(string sortingExpression)
		{
			...
			BO_ProgramStaff[] elements =new BO_ProgramStaff[this.Items.Count];
			this.Items.CopyTo(elements,0);
			Array.Sort(elements,this);
			//clear old order and copy new order here
			this.Items.Clear();
			foreach(BO_ProgramStaff item in elements)
				this.Items.Add(item);
		}
		...
		{
			return new BO_ProgramStaffs.Enumerator(this);
		}
