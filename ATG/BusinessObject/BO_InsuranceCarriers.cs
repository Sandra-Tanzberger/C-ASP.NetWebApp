//
// Class	:	BO_InsuranceCarriers.cs
// Author	:  	Ignyte Software © 2006 (DLG 1.5.64)
// Date		:	09/21/2010 12:38:17 PM
//
...
{
    [Serializable]
    public class BO_InsuranceCarriers : Collection<BO_InsuranceCarrier>, IEnumerable<BO_InsuranceCarrier>, IComparer
	{
         ...
         public class Enumerator : IEnumerator
         {
	        ...
	        private BO_InsuranceCarriers t;

	        public Enumerator (BO_InsuranceCarriers t)
	        {
		        this.t = t;
	        }
		...
		public void Sort(string sortingExpression)
		{
			...
			BO_InsuranceCarrier[] elements =new BO_InsuranceCarrier[this.Items.Count];
			this.Items.CopyTo(elements,0);
			Array.Sort(elements,this);
			//clear old order and copy new order here
			this.Items.Clear();
			foreach(BO_InsuranceCarrier item in elements)
				this.Items.Add(item);
		}
		...
		{
			return new BO_InsuranceCarriers.Enumerator(this);
		}
