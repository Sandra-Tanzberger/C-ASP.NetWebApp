//
// Class	:	BO_ObjctTyps.cs
// Author	:  	Ignyte Software © 2006 (DLG 1.5.64)
// Date		:	10/06/2010 4:45:59 PM
//
...
{
	public class BO_ObjctTyps :Collection<BO_ObjctTyp>, IEnumerable<BO_ObjctTyp>, IComparer
	{
         ...
         public class Enumerator : IEnumerator
         {
	        ...
	        private BO_ObjctTyps t;

	        public Enumerator (BO_ObjctTyps t)
	        {
		        this.t = t;
	        }
		...
		{
			return new BO_ObjctTyps.Enumerator(this);
		}
