//
// Class	:	BO_BsnsObjctPrimaryKey.cs
...
{
    public class BO_BsnsObjctPrimaryKey
    {
        ...
        /// </summary>
		public BO_BsnsObjctPrimaryKey(decimal? objctID) 
		{
		...
		/// <summary>
		/// This property is mapped to the "OBJCT_ID" field.  Mandatory.
		/// </summary>
