//
// Class	:	BO_MessageTemplates.cs
// Author	:  	Ignyte Software © 2006 (DLG 1.5.64)
// Date		:	12/01/2010 10:45:49 AM
//
...
{
    [Serializable]
    public class BO_MessageTemplates : Collection<BO_MessageTemplate>, IEnumerable<BO_MessageTemplate>, IComparer
	{
         ...
         public class Enumerator : IEnumerator
         {
	        ...
	        private BO_MessageTemplates t;

	        public Enumerator (BO_MessageTemplates t)
	        {
		        this.t = t;
	        }
		...
		public void Sort(string sortingExpression)
		{
			...
			BO_MessageTemplate[] elements =new BO_MessageTemplate[this.Items.Count];
			this.Items.CopyTo(elements,0);
			Array.Sort(elements,this);
			//clear old order and copy new order here
			this.Items.Clear();
			foreach(BO_MessageTemplate item in elements)
				this.Items.Add(item);
		}
		...
		{
			return new BO_MessageTemplates.Enumerator(this);
		}
