...
{
    [Serializable]
    public class BO_Actions : Collection<BO_Action>, IEnumerable<BO_Action>, IComparer
	{
         ...
         public class Enumerator : IEnumerator
         {
	        ...
	        private BO_Actions t;

	        public Enumerator (BO_Actions t)
	        {
		        this.t = t;
	        }
		...
		{
			return new BO_Actions.Enumerator(this);
		}
