...
{
    [Serializable]
    public class BO_Counties : Collection<BO_County>, IEnumerable<BO_County>, IComparer
	{
         ...
         public class Enumerator : IEnumerator
         {
	        ...
	        private BO_Counties t;

	        public Enumerator (BO_Counties t)
	        {
		        this.t = t;
	        }
		...
		{
			return new BO_Counties.Enumerator(this);
		}
