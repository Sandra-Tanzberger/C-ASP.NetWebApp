...
{
    [Serializable]
	public class BO_Capacities :Collection<BO_Capacity>, IEnumerable<BO_Capacity>, IComparer
	{
         ...
         public class Enumerator : IEnumerator
         {
	        ...
	        private BO_Capacities t;

	        public Enumerator (BO_Capacities t)
	        {
		        this.t = t;
	        }
		...
		{
			return new BO_Capacities.Enumerator(this);
		}
