...
{
	public class BO_BsnsrlMstrs :Collection<BO_BsnsrlMstr>, IEnumerable<BO_BsnsrlMstr>, IComparer
	{
         ...
         public class Enumerator : IEnumerator
         {
	        ...
	        private BO_BsnsrlMstrs t;

	        public Enumerator (BO_BsnsrlMstrs t)
	        {
		        this.t = t;
	        }
		...
		public void Sort(string sortingExpression)
		{
			...
			BO_BsnsrlMstr[] elements =new BO_BsnsrlMstr[this.Items.Count];
			this.Items.CopyTo(elements,0);
			Array.Sort(elements,this);
			//clear old order and copy new order here
			this.Items.Clear();
			foreach(BO_BsnsrlMstr item in elements)
				this.Items.Add(item);
		}
		...
		{
			return new BO_BsnsrlMstrs.Enumerator(this);
		}
