...
{
	public class BO_AspenComments :Collection<BO_AspenComment>, IEnumerable<BO_AspenComment>, IComparer
	{
         ...
         public class Enumerator : IEnumerator
         {
	        ...
	        private BO_AspenComments t;

	        public Enumerator (BO_AspenComments t)
	        {
		        this.t = t;
	        }
		...
		public void Sort(string sortingExpression)
		{
			...
			BO_AspenComment[] elements =new BO_AspenComment[this.Items.Count];
			this.Items.CopyTo(elements,0);
			Array.Sort(elements,this);
			//clear old order and copy new order here
			this.Items.Clear();
			foreach(BO_AspenComment item in elements)
				this.Items.Add(item);
		}
		...
		{
			return new BO_AspenComments.Enumerator(this);
		}
