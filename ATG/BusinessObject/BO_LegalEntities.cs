//
// Class	:	BO_LegalEntities.cs
// Author	:  	Ignyte Software © 2006 (DLG 1.5.64)
// Date		:	09/21/2010 12:38:21 PM
//
...
{
    [Serializable]
    public class BO_LegalEntities : Collection<BO_LegalEntity>, IEnumerable<BO_LegalEntity>, IComparer
	{
         ...
         public class Enumerator : IEnumerator
         {
	        ...
	        private BO_LegalEntities t;

	        public Enumerator (BO_LegalEntities t)
	        {
		        this.t = t;
	        }
		...
		public void Sort(string sortingExpression)
		{
			...
			BO_LegalEntity[] elements =new BO_LegalEntity[this.Items.Count];
			this.Items.CopyTo(elements,0);
			Array.Sort(elements,this);
			//clear old order and copy new order here
			this.Items.Clear();
			foreach(BO_LegalEntity item in elements)
				this.Items.Add(item);
		}
		...
		{
			return new BO_LegalEntities.Enumerator(this);
		}
