...
{
    [Serializable]
    public class BO_BillingDetails : Collection<BO_BillingDetail>, IEnumerable<BO_BillingDetail>, IComparer
	{
         ...
         public class Enumerator : IEnumerator
         {
	        ...
	        private BO_BillingDetails t;

	        public Enumerator (BO_BillingDetails t)
	        {
		        this.t = t;
	        }
		...
		public void Sort(string sortingExpression)
		{
			...
			BO_BillingDetail[] elements =new BO_BillingDetail[this.Items.Count];
			this.Items.CopyTo(elements,0);
			Array.Sort(elements,this);
			//clear old order and copy new order here
			this.Items.Clear();
			foreach(BO_BillingDetail item in elements)
				this.Items.Add(item);
		}
		...
		{
			return new BO_BillingDetails.Enumerator(this);
		}
