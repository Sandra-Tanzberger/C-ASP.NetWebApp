...
{
    [Serializable]
    public class BO_States : Collection<BO_State>, IEnumerable<BO_State>, IComparer
	{
		...
		{
			return new BO_States.Enumerator(this);
		}
