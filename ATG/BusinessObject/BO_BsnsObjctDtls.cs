...
{
	public class BO_BsnsObjctDtls :Collection<BO_BsnsObjctDtl>, IEnumerable<BO_BsnsObjctDtl>, IComparer
	{
         ...
         public class Enumerator : IEnumerator
         {
	        ...
	        private BO_BsnsObjctDtls t;

	        public Enumerator (BO_BsnsObjctDtls t)
	        {
		        this.t = t;
	        }
		...
		public void Sort(string sortingExpression)
		{
			...
			BO_BsnsObjctDtl[] elements =new BO_BsnsObjctDtl[this.Items.Count];
			this.Items.CopyTo(elements,0);
			Array.Sort(elements,this);
			//clear old order and copy new order here
			this.Items.Clear();
			foreach(BO_BsnsObjctDtl item in elements)
				this.Items.Add(item);
		}
		...
		{
			return new BO_BsnsObjctDtls.Enumerator(this);
		}
