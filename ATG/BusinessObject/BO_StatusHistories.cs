//
// Class	:	BO_StatusHistories.cs
// Author	:  	Ignyte Software © 2006 (DLG 1.5.64)
// Date		:	02/16/2011 12:09:22 PM
//
...
{
  [Serializable]
	public class BO_StatusHistories :Collection<BO_StatusHistory>, IEnumerable<BO_StatusHistory>, IComparer
	{
         ...
         public class Enumerator : IEnumerator
         {
	        ...
	        private BO_StatusHistories t;

	        public Enumerator (BO_StatusHistories t)
	        {
		        this.t = t;
	        }
		...
		public void Sort(string sortingExpression)
		{
			...
			BO_StatusHistory[] elements =new BO_StatusHistory[this.Items.Count];
			this.Items.CopyTo(elements,0);
			Array.Sort(elements,this);
			//clear old order and copy new order here
			this.Items.Clear();
			foreach(BO_StatusHistory item in elements)
				this.Items.Add(item);
		}
		...
		{
			return new BO_StatusHistories.Enumerator(this);
		}
