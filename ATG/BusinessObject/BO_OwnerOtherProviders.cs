//
// Class	:	BO_OwnerOtherProviders.cs
...
{
    [Serializable]
    public class BO_OwnerOtherProviders : Collection<BO_OwnerOtherProvider>, IEnumerable<BO_OwnerOtherProvider>, IComparer
	{
         ...
         public class Enumerator : IEnumerator
         {
	        ...
	        private BO_OwnerOtherProviders t;

	        public Enumerator (BO_OwnerOtherProviders t)
	        {
		        this.t = t;
	        }
		...
		public void Sort(string sortingExpression)
		{
			...
			BO_OwnerOtherProvider[] elements =new BO_OwnerOtherProvider[this.Items.Count];
			this.Items.CopyTo(elements,0);
			Array.Sort(elements,this);
			//clear old order and copy new order here
			this.Items.Clear();
			foreach(BO_OwnerOtherProvider item in elements)
				this.Items.Add(item);
		}
		...
		{
			return new BO_OwnerOtherProviders.Enumerator(this);
		}
