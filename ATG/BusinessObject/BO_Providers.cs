...
{
    [Serializable]
    public class BO_Providers : Collection<BO_Provider>, IEnumerable<BO_Provider>, IComparer
	{
         ...
         public class Enumerator : IEnumerator
         {
	        ...
	        private BO_Providers t;

	        public Enumerator (BO_Providers t)
	        {
		        this.t = t;
	        }
		...
		{
			return new BO_Providers.Enumerator(this);
		}
