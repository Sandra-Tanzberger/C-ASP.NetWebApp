//
// Class	:	BO_ChecklistItems.cs
// Author	:  	Ignyte Software © 2006 (DLG 1.5.64)
// Date		:	09/21/2010 2:43:13 PM
//
...
{
    [Serializable]
    public class BO_ChecklistItems : Collection<BO_ChecklistItem>, IEnumerable<BO_ChecklistItem>, IComparer
	{
         ...
         public class Enumerator : IEnumerator
         {
	        ...
	        private BO_ChecklistItems t;

	        public Enumerator (BO_ChecklistItems t)
	        {
		        this.t = t;
	        }
		...
		public void Sort(string sortingExpression)
		{
			...
			BO_ChecklistItem[] elements =new BO_ChecklistItem[this.Items.Count];
			this.Items.CopyTo(elements,0);
			Array.Sort(elements,this);
			//clear old order and copy new order here
			this.Items.Clear();
			foreach(BO_ChecklistItem item in elements)
				this.Items.Add(item);
		}
		...
		{
			return new BO_ChecklistItems.Enumerator(this);
		}
