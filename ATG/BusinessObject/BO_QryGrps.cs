...
{
	public class BO_QryGrps :Collection<BO_QryGrp>, IEnumerable<BO_QryGrp>, IComparer
	{
         ...
         public class Enumerator : IEnumerator
         {
	        ...
	        private BO_QryGrps t;

	        public Enumerator (BO_QryGrps t)
	        {
		        this.t = t;
	        }
		...
		{
			return new BO_QryGrps.Enumerator(this);
		}
