//
// Class	:	BO_ApplicationSupports.cs
...
{
	public class BO_ApplicationSupports :Collection<BO_ApplicationSupport>, IEnumerable<BO_ApplicationSupport>, IComparer
	{
         ...
         public class Enumerator : IEnumerator
         {
	        ...
	        private BO_ApplicationSupports t;

	        public Enumerator (BO_ApplicationSupports t)
	        {
		        this.t = t;
	        }
		...
		public void Sort(string sortingExpression)
		{
			...
			BO_ApplicationSupport[] elements =new BO_ApplicationSupport[this.Items.Count];
			this.Items.CopyTo(elements,0);
			Array.Sort(elements,this);
			//clear old order and copy new order here
			this.Items.Clear();
			foreach(BO_ApplicationSupport item in elements)
				this.Items.Add(item);
		}
		...
		{
			return new BO_ApplicationSupports.Enumerator(this);
		}
