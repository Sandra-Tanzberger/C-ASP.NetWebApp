...
{
    [Serializable]
	public class BO_Addresses :Collection<BO_Address>, IEnumerable<BO_Address>, IComparer
	{
         ...
         public class Enumerator : IEnumerator
         {
	        ...
	        private BO_Addresses t;

	        public Enumerator (BO_Addresses t)
	        {
		        this.t = t;
	        }
		...
		{
			return new BO_Addresses.Enumerator(this);
		}
