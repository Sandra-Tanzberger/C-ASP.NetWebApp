...
{
    [Serializable]
    public class BO_Services : Collection<BO_Service>, IEnumerable<BO_Service>, IComparer
	{
         ...
         public class Enumerator : IEnumerator
         {
	        ...
	        private BO_Services t;

	        public Enumerator (BO_Services t)
	        {
		        this.t = t;
	        }
		...
		{
			return new BO_Services.Enumerator(this);
		}
