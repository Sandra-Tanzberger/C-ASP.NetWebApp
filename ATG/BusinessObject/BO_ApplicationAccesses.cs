//
// Class	:	BO_ApplicationAccesses.cs
// Author	:  	Ignyte Software © 2006 (DLG 1.5.64)
// Date		:	09/23/2019 2:26:38 PM
//
...
{
	public class BO_ApplicationAccesses :Collection<BO_ApplicationAccess>, IEnumerable<BO_ApplicationAccess>, IComparer
	{
         ...
         public class Enumerator : IEnumerator
         {
	        ...
	        private BO_ApplicationAccesses t;

	        public Enumerator (BO_ApplicationAccesses t)
	        {
		        this.t = t;
	        }
		...
		public void Sort(string sortingExpression)
		{
			...
			BO_ApplicationAccess[] elements =new BO_ApplicationAccess[this.Items.Count];
			this.Items.CopyTo(elements,0);
			Array.Sort(elements,this);
			//clear old order and copy new order here
			this.Items.Clear();
			foreach(BO_ApplicationAccess item in elements)
				this.Items.Add(item);
		}
		...
		{
			return new BO_ApplicationAccesses.Enumerator(this);
		}
