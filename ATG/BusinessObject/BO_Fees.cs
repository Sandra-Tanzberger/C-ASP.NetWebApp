...
{
    [Serializable]
    public class BO_Fees : Collection<BO_Fee>, IEnumerable<BO_Fee>, IComparer
	{
		...
		{
			return new BO_Fees.Enumerator(this);
		}
