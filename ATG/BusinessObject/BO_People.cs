...
{
    [Serializable]
    public class BO_People : Collection<BO_Person>, IEnumerable<BO_Person>, IComparer
	{
		...
		{
			return new BO_People.Enumerator(this);
		}
