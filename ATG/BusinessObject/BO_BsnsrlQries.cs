//
// Class	:	BO_BsnsrlQries.cs
// Author	:  	Ignyte Software © 2006 (DLG 1.5.64)
// Date		:	10/06/2010 4:46:02 PM
//
...
{
	public class BO_BsnsrlQries :Collection<BO_BsnsrlQry>, IEnumerable<BO_BsnsrlQry>, IComparer
	{
         ...
         public class Enumerator : IEnumerator
         {
	        ...
	        private BO_BsnsrlQries t;

	        public Enumerator (BO_BsnsrlQries t)
	        {
		        this.t = t;
	        }
		...
		public void Sort(string sortingExpression)
		{
			...
			BO_BsnsrlQry[] elements =new BO_BsnsrlQry[this.Items.Count];
			this.Items.CopyTo(elements,0);
			Array.Sort(elements,this);
			//clear old order and copy new order here
			this.Items.Clear();
			foreach(BO_BsnsrlQry item in elements)
				this.Items.Add(item);
		}
		...
		{
			return new BO_BsnsrlQries.Enumerator(this);
		}
