...
{
    [Serializable]
    public class BO_ProviderPeople : Collection<BO_ProviderPerson>, IEnumerable<BO_ProviderPerson>, IComparer
	{
         ...
         public class Enumerator : IEnumerator
         {
	        ...
	        private BO_ProviderPeople t;

	        public Enumerator (BO_ProviderPeople t)
	        {
		        this.t = t;
	        }
		...
		public void Sort(string sortingExpression)
		{
			...
			BO_ProviderPerson[] elements =new BO_ProviderPerson[this.Items.Count];
			this.Items.CopyTo(elements,0);
			Array.Sort(elements,this);
			//clear old order and copy new order here
			this.Items.Clear();
			foreach(BO_ProviderPerson item in elements)
				this.Items.Add(item);
		}
		...
		{
			return new BO_ProviderPeople.Enumerator(this);
		}
