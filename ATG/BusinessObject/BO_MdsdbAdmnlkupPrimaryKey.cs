//
// Class	:	BO_MdsdbAdmnlkupPrimaryKey.cs
...
{
    public class BO_MdsdbAdmnlkupPrimaryKey
    {
        ...
        /// </summary>
		public BO_MdsdbAdmnlkupPrimaryKey(decimal? adminid) 
		{
	
			
            this._adminidNonDefault = adminid;
		...
		public NameValueCollection GetKeysAndValues() 
		{
			...
			nvc.Add("Adminid",_adminidNonDefault.ToString());
			return nvc;
