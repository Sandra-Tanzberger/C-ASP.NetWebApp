<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BillingHistoryPage.aspx.cs" Inherits="DHH.BillingHistoryPage" %>
...
<head id="Head1" runat="server">
 ...
 <body>
    <form id="form1" runat="server">
        ...
        <telerik:RadAjaxManager ID="BillingHistoryPageRAM" runat="server">
        ...
        <br />
        <div>
        <asp:panel ScrollBars="None" id="BillingContent" runat="server"></asp:panel>
        </div>
    </form>
</body>
</html>
